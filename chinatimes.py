...
def chinatimes(urlx):
    for page in range(1,3): #(93 total business )  ,42 in politics ,20 in world
        cnt=0
        url=urlx+str(page)
        ...
        for i in span:
          url2='http://www.thechinatimes.com/'
          genre_=soup.find('nav',attrs={'class':'gabfire_breadcrumb'})
          genre=genre_.contents[-1].strip()
          genre=genre[:8]
          if (genre == 'World (P'):
...
chinatimes('http://www.thechinatimes.com/business/page/')
#chinatimes('https://www.thechinatimes.com/politics/page/')
#chinatimes('https://www.thechinatimes.com/world/page/')
#ye nhi hue abh ise uni me lagana ah....
