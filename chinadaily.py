...
def chinadaily(urlx):
    for page in range(6,8): #(126 in money, 176 in companies, 99 in tech) 
        cnt=0
        ...
        genre='Business'
        span=soup.find_all('span',attrs={'class':'tw3_01_2_t'})
        for i in span:
           url2='http://www.chinadaily.com.cn/'
           news='CHINA DAILY'
           topic=i.find('a').text
           ref_=i.find('a')['href']    
           ref='http:'+ref_
           ...
           country='CHINA'
           genre_=soup2.find('ol',attrs={'id':'bread-nav1','class':'breadcrumb res-m'})
           if genre_:
               genre=genre_.find("li").find_next_sibling().text
           else: 
                genre='not mentioned'
           print(genre)
           tab=soup2.find_all('div',attrs={'id':'Content'})
           context=''
           for x in tab:
...
chinadaily('http://www.chinadaily.com.cn/business/biz_industries/page_')
chinadaily('http://www.chinadaily.com.cn/business/money/page_')
chinadaily('http://www.chinadaily.com.cn/business/companies/page_')
chinadaily('http://www.chinadaily.com.cn/business/tech/page_')
chinadaily('http://www.chinadaily.com.cn/world/america/page_')
chinadaily('http://www.chinadaily.com.cn/world/asia_pacific/page_')
#chinadaily('http://www.chinadaily.com.cn/sports/soccer/page_')
chinadaily('http://www.chinadaily.com.cn/world/europe/page_')
