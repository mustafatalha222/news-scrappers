...
def hindustan(url):
    ...
    span=soup.find_all('div',attrs={'class':'media-heading headingfour'})
    for i in span:
       news='hindustantimes'
       url2='http://www.hindustantimes.com/'
       country='INDIA'
       topic=i.find('a').text
       ref=i.find('a')['href']
       print(ref)
       ...
       genre_=soup2.find('a',attrs={'class':'cta-link'})
       if genre_:
           genre=genre_.text.strip()
           print(genre)
           date=soup2.find('span',attrs={'class':'text-dt'}).text
           date=dated(date)
           tab=soup2.find_all('div',attrs={'class':'story-details'})
           context=''
           for x in tab:
...
#hindustan('http://www.hindustantimes.com/india-news/') #44
#hindustan('http://www.hindustantimes.com/cricket/') #45
hindustan('http://www.hindustantimes.com/world-news/') #45
#hindustan('http://www.hindustantimes.com/cities/') #45
#hindustan('http://www.hindustantimes.com/tech/') 
#hindustan('http://www.hindustantimes.com/education/') 
#hindustan('http://www.hindustantimes.com/entertainment/') 
hindustan('http://www.hindustantimes.com/business-news/')#47
